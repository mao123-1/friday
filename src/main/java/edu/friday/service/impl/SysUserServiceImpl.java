...
public class SysUserServiceImpl implements SysUserService {
    ...
    @Override
    public TableDataInfo selectUserList(SysUserVO userVO, Pageable pageable) {  // 修正参数名和类型与接口一致
        SysUser sysuser = new SysUser();
        BeanUtils.copyPropertiesIgnoreEmpty(userVO, sysuser);  // 同步修改参数名
        ...
        Page<SysUser> rs = sysUserRepository.findAll(example, pageable);  // 同步修改参数名
